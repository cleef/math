# light-learning-apps（学习应用集合）

`light-learning-apps` 用于管理数学、英语等学习应用集合：每个应用是独立前端项目，构建后统一输出到 `dist/apps/<id>/`，由 `light-learning-hub` 托管。

## 目录结构

```text
apps/<id>/            # 单个学习应用目录
templates/light-app/  # 学习应用模板
...
访问 [http://localhost:5173/](http://localhost:5173/)，在 Hub 中进入对应学习应用。
