...
export const messages: Record<Locale, MessageCatalog> = {
  "zh-CN": {
    topNav: {
      homeAriaLabel: "返回学习首页",
      brandSubtitle: "学习工作台",
      subjectNavAriaLabel: "学科导航",
    ...
    home: {
      eyebrow: "Light Learning",
      title: "今天想探索什么？",
      subtitle: "选择一个学科，进入可以观察、尝试和创造的学习体验。",
      subjectNavAriaLabel: "选择学科",
      courseCount: (count) => `${count} 个课程`
    },
    detail: {
      lessonReady: "课程已就绪",
      startLearning: "开始学习",
  ...
  "en-US": {
    topNav: {
      homeAriaLabel: "Back to Learning Home",
      brandSubtitle: "Learning Studio",
      subjectNavAriaLabel: "Subject navigation",
      searchPlaceholder: "Search by app name, topic, or grade",
      searchAriaLabel: "Search learning apps",
      searchButton: "Search",
    ...
    list: {
      ...
      allTagLabel: "All",
      subjectEyebrow: "Subject Courses",
      filterSummary: ({ shown, total, activeTag, query }) => {
    ...
    home: {
      ...
      subtitle: "Choose a subject and enter a learning experience built for noticing, testing, and creating.",
      subjectNavAriaLabel: "Choose a subject",
      courseCount: (count) => `${count} ${count === 1 ? "course" : "courses"}`
    },
    detail: {
    ...
    statePages: {
      ...
      backHome: "Back to Learning Home",
      reload: "Reload"
    },
    appCard: {
      defaultOwner: "Learning Team",
